                ...
                <div class="row">
                  <div class="col-12">
                    <div class="top-banner-wrapper">
                      <a href="#">
                        <img src='https://www.catman.global/wp-content/uploads/2017/11/BlackFriday.png' style="height: 200px; width: 100%; object-fit: cover" class="img-fluid" alt />
                      </a>
                    </div>
                      ...
                      <div class="product-wrapper-grid" :class="{ 'list-view': listview == true }">
                        <div class="row">
                          ...
                          <div class="col-grid-box"
                            ...
                            v-for="(product, index) in products" :key="index" v-show="setPaginate(index)">
