                ...
                <div class="row">
                  <div class="col-lg-6">
                    <swiper @swiper="onSwiper" :slidesPerView="1" :spaceBetween="20" class="swiper-wrapper h-auto">
                      <swiper-slide class="swiper-slide"  :key="product.id">
                        <img :src="product.image" :id="product.id" style="height: 500px; object-fit: cover" class="img-fluid bg-img"
                          :alt="product.id" />
                      </swiper-slide>
                    </swiper>
                    <div class="row">
                      <div class="col-12 slider-nav-images">
                        <swiper :slidesPerView="3" slide-active-class="true" :spaceBetween="20" class="swiper-wrapper">
                          <swiper-slide class="swiper-slide"  :key="product.id"
                            :class="slideId === product.id ? 'product-slider-active' : ''">
                            <img :src="product.image" :id="product.id" class="img-fluid bg-img"
                              alt="product.alt" @click="slideTo(product.id)" />
                          </swiper-slide>
                        </swiper>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-6 rtl-text">
                    <div class="product-right">
                      <h2>{{ product.title }}</h2>
                      <h3 v-if="product.status">
                        GHS  {{ product.price }} <del>{{product.price}} % off</del>
                      </h3>
                      <h3 v-else>
                        GHS  {{ product.price }}
                      </h3>
                      ...
                      <div class="product-buttons">
                        <nuxt-link :to="{ path: '/page/account/cart' }">
                          <button class="btn btn-solid" title="Add to cart" @click="addToCart(product, counter)"
                            :disabled="counter > product.stock">Add To Cart</button>
                        </nuxt-link>
                        <button class="btn btn-solid" title="buy now" @click="buyNow(product, counter)"
                          :disabled="counter > product.stock">Buy Now</button>
                      </div>
